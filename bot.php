    ...
    <style>
        ...
        <body>
            ...
            <div class="container1" style="margin-right: 400px;">
                <img src="robot.jpg" alt="Avatar" style="width:100%;">
...
<div class="sticky">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" id="msg">
                    <div class="input-group-append">
                        <buttom class="btn btn-outline-secondary" type="button" onclick="send()">Send</buttom>
                    </div>
            </div>
        </div>
    </div>
    ...
    <p><h2> </h2><p>
        <center> 
        <buttom class="btn btn-outline-secondary" type="button" href="landingPage.html">End conversation</buttom></center>
    </div>
            </span>
            <br/>
